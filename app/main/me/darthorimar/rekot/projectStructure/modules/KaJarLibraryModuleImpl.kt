...
private class KaJarLibraryModuleImplScope private constructor(val roots: Set<String>) : GlobalSearchScope() {
    ...
    companion object {
        fun create(roots: List<Path>): KaJarLibraryModuleImplScope {
            return KaJarLibraryModuleImplScope(roots.mapTo(mutableSetOf()) { it.absolutePathString() + "!/" })
        }
    }
}